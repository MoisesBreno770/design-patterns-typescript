import { LightPowerCommand } from "./ligth-power-command";
import { SmartHouseApp } from "./smart-house-app";
import { SmartHouseLigth } from "./smart-house-ligth";

// Receiver
const bedroomLight = new SmartHouseLigth('Luz Quarto');
const bathroomLight = new SmartHouseLigth('Luz Banheiro');
...
const bedroomIntensityCommand = new LightPowerCommand(bedroomLight);
